...
against heuristic opponents in the mixed-final curriculum stage (see
...
This report is organised as follows.  Chapter~\ref{ch:background} provides
background on Pok\'{e}mon battle mechanics, the simulation environment, the
challenge model, data provenance, and the milestone roadmap.
Chapter~\ref{ch:methods} describes the complete methodology: the
reinforcement learning formulation, model architecture, training
infrastructure, and the iterative development process through which the
pipeline was debugged and improved.
Chapter~\ref{ch:results} presents training results for both fixed-team and
random-team settings, including a chronological development progression and
an honest assessment.  Chapter~\ref{ch:risk} discusses risk, ethical, and
human-in-the-loop considerations.  Chapter~\ref{ch:conclusions} concludes
with lessons learned and next steps.  Appendix~\ref{ch:reproduction} provides
a complete reproduction guide.
